...
public class CurrencyConversionV2
{
    public static void main(String [] args)
    {
    	...
    	System.out.println("The exchange rates can be found in comments in the source code");
    	
    	//peso exchange rate is 0.051
        ...
        System.out.print("1 peso = $" + pesoExchangeRate + '\n');
        ...
        double yenExchangeRate = in.nextDouble(); //1 Yen =  0.009738 USD
        System.out.print("1 Yen = $" + yenExchangeRate + '\n');
        double dollarsSpentInJapan = 0.0;
        
        double eurosSpent = 624.95;
        System.out.print("1 Euro = ");
        double euroExchangeRate = in.nextDouble(); //1 Euro = 1.123288 USD
        System.out.print("1 Euro = $" + euroExchangeRate + '\n');
