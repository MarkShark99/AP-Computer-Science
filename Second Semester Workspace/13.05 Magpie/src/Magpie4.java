...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            if (youPosition >= 0 && findKeyword(statement, "me", youPosition) >= 0)
            {
                response = transformYouMeStatement(statement);
            }
            else if (iPosition >= 0 && findKeyword(statement, "you", iPosition) >= 0)
            {
            	response = transformIXYouStatement(statement);
            }
            else
            {
    ...
    private String transformIXYouStatement(String statement)
    {
		//  Remove the final period, if there is one
		statement = statement.trim();
		String lastChar = statement.substring(statement.length() - 1);
