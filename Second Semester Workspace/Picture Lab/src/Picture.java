...
public class Picture extends SimplePicture 
{
	...
	public void createCollage()
	{
		...
		this.mirrorVertical();
		//this.write("collage.jpg"); //No thanks
	}
	...
	public void myCollage()
	{
		...
		this.copy(flower3, 10, 20, 0, 100);
		this.copy(flower2, 40, 30);
		this.copy(flower, 70, 80);
	}
	...
	public void edgeDetection2(double threshold) //I didn't have a group :(
	{
